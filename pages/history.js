	...
	<>
		...
		<EventsContainer>
			<Event icon={faMask} name="Imposter" time="April 2020">
				...
				mixed with one generated by an AI and needed to determine which one was
			...
			<Event
				...
				time="April 2018"
			>
				During Circle of Trust, each player could create a single circle with
				...
				the backend and added anyone running the extension before the circle could
				be betrayed.
			</Event>
			<Event
				icon={faBirthdayCake}
